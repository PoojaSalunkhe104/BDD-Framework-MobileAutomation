...
public class AndroidPTStop_OptionsPage extends AndroidBasePage implements PTStop_Options
{
	

    public AndroidPTStop_OptionsPage(AppiumDriver<MobileElement> driver) {
		super(driver);
	}
