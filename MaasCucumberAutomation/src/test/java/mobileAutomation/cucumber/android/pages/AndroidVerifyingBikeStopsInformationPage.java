...
public class AndroidVerifyingBikeStopsInformationPage  extends AndroidBasePage implements VerifyingBikeStopsInformationPage
{
	...
	public AndroidVerifyingBikeStopsInformationPage(AppiumDriver<MobileElement> driver) {
		super(driver);
	}
