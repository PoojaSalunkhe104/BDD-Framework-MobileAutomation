...
public class iOSPTStop_OptionsPage extends iOSBasePage implements PTStop_Options
{

	public iOSPTStop_OptionsPage(AppiumDriver<MobileElement> driver) {
		super(driver);
   	...
   	private MobileElement Continue; 
	    ...
	    @Override
			...
			public void verifyWalkIcon(Scenario scenario) throws InterruptedException 
			{
		    	...
		    	//Continue page and Allow While Using App popup comes on bitrise  
		    	try{
		            Continue.click();
		            AllowWhileUsingApp.click();
		            Thread.sleep(10000);
